<template>
  <nav class="sidebar" :class="{ collapsed: sidebarCollapsed }">
    ...
    <div class="sidebar-top">
      ...
      <router-link to="/"><span class="nav-icon">&#127968;</span> <span class="nav-label">Home</span></router-link>
      <router-link to="/dashboard"><span class="nav-icon">&#9776;</span> <span class="nav-label">Dashboard</span></router-link>
